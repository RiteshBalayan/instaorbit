...
export class PolynomialRegression {
    ...
    static _bayesInformationCriterea(n, k, sse) {
     ...
     */
    static solve(xs, ys, order, { printIter = false } = {}) {
        ...
        const sse = f(result);
        return new PolynomicalRegressionResult(result, Math.sqrt(sse), PolynomialRegression._bayesInformationCriterea(xs.length, order, sse));
    }
    /**
     ...
     * @returns The optimal input value.
     */
    static solveOrder(xs, ys, minOrder, maxOrder, { printIter = false } = {}) {
        const cache = [];
...
//# sourceMappingURL=PolynomialRegression.js.map