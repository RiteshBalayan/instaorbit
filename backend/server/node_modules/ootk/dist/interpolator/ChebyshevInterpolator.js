...
export class ChebyshevInterpolator extends StateInterpolator {
    ...
    window() {
        return new EpochWindow(new EpochUTC(this._coefficients[0].a), new EpochUTC(this._coefficients[this._coefficients.length - 1].b));
    }
    _matchCoefficients(posix) {
        let left = 0;
...
//# sourceMappingURL=ChebyshevInterpolator.js.map